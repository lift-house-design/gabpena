...
class App_Controller extends Old_App_Controller
{
    protected function _load_data()
    {
        ...
        $this->css=array_merge($this->css,$this->min_css);
        $this->js=array_merge($this->js,$this->min_js);
        $this->min_css=array();
        $this->min_js=array();

        return parent::_load_data();
    }
}

class Old_App_Controller extends CI_Controller
{
    ...
    protected $min_css = array(
        'normalize.css',
        'application.css',
        '/plugins/fancybox2/jquery.fancybox.css',
        'mobile.css'
    );
